...
<ImageModal src="/img/cmu15-445/c16/image-1.webp" caption="Schedule" />
<ImageModal src="/img/cmu15-445/c16/image-2.webp" caption="Schedule" />
...
<ImageModal src="/img/cmu15-445/c16/image-3.webp" caption="Conflict" />

#### Write-Read Conflict

會導致 dirty read，也就是當一個 transaction 讀取到另一個 transaction 還未 commit 的資源。

<ImageModal src="/img/cmu15-445/c16/image-4.webp" caption="Conflict" />

#### Write-Write Conflict

會導致 lost update，也就是當兩個 transaction 同時寫入同一個資源時，後者會覆蓋前者的值。

<ImageModal src="/img/cmu15-445/c16/image-5.webp" caption="Conflict" />
...
<ImageModal src="/img/cmu15-445/c16/image-7.webp" caption="Serializability" />
