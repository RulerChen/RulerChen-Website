...
<ImageModal src="/img/cmu15-445/c12/image-1.webp" caption="Join Output" />
...
<ImageModal src="/img/cmu15-445/c12/image-2.webp" caption="Early Materialization" />

#### Late Materialization

也可以只複製 join key 跟 record id，之後再去表中讀取資料，較適合 column store。

<ImageModal src="/img/cmu15-445/c12/image-3.webp" caption="Late Materialization" />
...
<ImageModal src="/img/cmu15-445/c12/image-12.webp" caption="Join Algorithms" />
