...
<ImageModal src="/img/cmu15-445/c20/image-1.webp" caption="Buffer Pool Management Policies" />
...
<ImageModal src="/img/cmu15-445/c20/image-2.webp" caption="Shadow Paging" />

當寫入的交易發生時，DBMS 會生成一份 shadow page，並在 shadow page 上進行修改，並將 DB root 的指針指向 shadow page，同時將資料都存在硬碟上。

<ImageModal src="/img/cmu15-445/c20/image-3.webp" caption="Shadow Paging" />
...
<ImageModal src="/img/cmu15-445/c20/image-6.webp" caption="Shadow Paging" />
