...
```java title="DetailedHttpServer.java"
...
由於我們前面要求回傳的 shell 是 bash，但在這個 container 中並沒有 bash，
因此我們需要在 container 中安裝 bash :
